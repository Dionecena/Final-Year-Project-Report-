  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={() => { setShowForm(!showForm); setEditingSpecialty(null); setFormData({ name: '', description: '' }); }}
            ...
            <div key={specialty.id} className="card">
              <div>
                ...
                {specialty.description && (
                  <p className="text-sm text-gray-500 mt-1 line-clamp-2">{specialty.description}</p>
                )}
              </div>
