...
class AuthController extends Controller
{
     ...
     *
     * SECURITE : Le role est force a 'patient'.
     * Seul un admin peut creer des comptes medecin/secretaire via POST /api/admin/users.
     */
    public function register(Request $request): JsonResponse
    {
        ...
        // SECURITE : role force a patient, on ignore toute valeur envoyee
        $user = User::create([
            'name' => $validated['name'],
